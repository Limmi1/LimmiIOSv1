    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(spacing: 32) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        VStack(spacing: 8) {
                            Text("Choose your beacon (Optional)")
                                .font(.title2)
                                .fontWeight(.semibold)
                                .foregroundColor(.primary)
                                .multilineTextAlignment(.center)
                            
                            Text("Select a beacon to control when apps are blocked, or skip to use GPS location only")
                                .font(.body)
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 12) {
                    // Skip Beacon Button (when no beacon selected)
                    ...
                    // Continue Button (when beacon selected)
